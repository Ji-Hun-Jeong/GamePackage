...
namespace Graphics
{
	...
	public:
		...
		virtual std::unique_ptr<CBuffer> CreateBuffer(const TBufferDesc& InBufferDesc, const TBufferInitalizeData* InBufferInitalizeData) = 0;
		virtual std::unique_ptr<CTexture2D> CreateTexture2D(const TTexture2DDesc& InTexture2DDesc, const TBufferInitalizeData* InBufferInitalizeData) = 0;
